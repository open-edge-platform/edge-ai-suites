...
```bash
cd edge-ai-suites/federal-and-aerospace-ai-suite/apps/deterministic-threat-detection/usecases/rtsp-deterministic-inference/mqtt_data_aggregator
pip install -r requirements.txt
```

## Running the Script

Navigate to the `edge-ai-suites/federal-and-aerospace-ai-suite/apps/deterministic-threat-detection/usecases/rtsp-deterministic-inference/mqtt_data_aggregator` directory and run the
script. You will need to provide the correct broker IP addresses for each topic.

```bash
cd federal-and-aerospace-ai-suite/apps/deterministic-threat-detection/usecases/rtsp-deterministic-inference/mqtt_data_aggregator
