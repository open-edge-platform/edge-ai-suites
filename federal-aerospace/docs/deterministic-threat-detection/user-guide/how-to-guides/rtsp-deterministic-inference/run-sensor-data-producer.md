...
```bash
cd federal-and-aerospace-ai-suite/apps/deterministic-threat-detection/usecases/rtsp-deterministic-inference/sensor_data_producer
...
```bash
cd edge-ai-suites/federal-and-aerospace-ai-suite/apps/deterministic-threat-detection/usecases/rtsp-deterministic-inference/sensor_data_producer
docker run -d \
  --name mqtt-broker \
  --network host \
...
Navigate to the `edge-ai-suites/federal-and-aerospace-ai-suite/apps/deterministic-threat-detection/usecases/rtsp-deterministic-inference/sensor_data_producer` directory and run the script from there. You
