...
- Review the [UAV Mission Compute SDK Benchmarking Guide](https://github.com/open-edge-platform/edge-ai-suites/blob/release-2026.2.0/federal-and-aerospace-ai-suite/uav-mission-compute-sdk/docs/user-guide/benchmarking.md) for telemetry and bridge performance benchmarking and tuning.

- Refer to [Get Started — UAV Mission Compute SDK Mode](./get-started-uavsdk.md) for sample application deployment and running the vision analytics stack against the live UAV SDK services.
