...
```
> Note: If you downloaded and extracted the zip file, replace `edge-ai-suites/federal-and-aerospace-ai-suite/apps/deterministic-threat-detection/` with the path to your extracted `deterministic-threat-detection/` folder.
