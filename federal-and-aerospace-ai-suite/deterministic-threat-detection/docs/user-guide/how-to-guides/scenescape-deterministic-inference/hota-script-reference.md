...
## [mqtt_camera_capture_processor.py](https://github.com/open-edge-platform/edge-ai-suites/blob/main/federal-and-aerospace-ai-suite/deterministic-threat-detection/usecases/scenescape-deterministic-inference/hota/scripts/hota-metrics/mqtt_camera_capture_processor.py)
...
## [traffic_generator.py](https://github.com/open-edge-platform/edge-ai-suites/blob/main/federal-and-aerospace-ai-suite/deterministic-threat-detection/usecases/scenescape-deterministic-inference/hota/scripts/traffic_generator.py)
...
## [sei_parser.py](https://github.com/open-edge-platform/edge-ai-suites/blob/main/federal-and-aerospace-ai-suite/deterministic-threat-detection/usecases/scenescape-deterministic-inference/hota/scripts/gvapython/sei_parser.py)
