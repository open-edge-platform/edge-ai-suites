...
For Windows Subsystem for Linux (WSL), follow the steps in the [Windows WSL Guide](https://github.com/open-edge-platform/edge-node-infrastructure-blueprint/blob/main/docs/user-guide/how-to/set-up-windows-wsl.md).
