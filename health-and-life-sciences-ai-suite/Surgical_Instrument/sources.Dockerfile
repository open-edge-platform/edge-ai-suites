...
ARG BACKEND_IMAGE=intel/hl-ai-surgical-backend:1.0.0
FROM ${BACKEND_IMAGE} AS source-builder
...
LABEL description="Source redistribution image for GPL-licensed packages in ${BACKEND_IMAGE}"
