...
def run_one(device: str) -> dict:
    ...
    per_elem = {}
    for elem in ("det", "gvatrack0", "gvametaconvert0", "gvawatermarkimpl0", "jpegenc0"):
...
def main() -> None:
    ...
    print("| Device | det | gvatrack0 | gvametaconvert0 | gvawatermarkimpl0 | jpegenc0 | sum (mean) |")
    print("|--------|-----|-----------|-----------------|--------------------|----------|------------|")
    for r in results:
        if "error" in r:
            continue
        ...
        cells = " | ".join(
            ...
            ("det", "gvatrack0", "gvametaconvert0", "gvawatermarkimpl0", "jpegenc0")
        )
