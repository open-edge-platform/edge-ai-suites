...
The MQTT publisher simulator is used for ingesting the weld data and wind turbine data in the `Weld Anomaly Detection Sample App` and `Weld Anomaly Detection Sample App` respectively.
...
### [1.1.0](https://docs.openedgeplatform.intel.com/dev/edge-ai-suites/ai-suite-manufacturing/industrial-edge-insights-time-series/release_notes.html#v2025-2-december-2025)
