...
The MQTT publisher simulator is used for ingesting the weld data and wind turbine data in the `Time-Series Weld Defect Detection Sample App` and `Wind Turbine Anomaly Detection Sample App` respectively.
