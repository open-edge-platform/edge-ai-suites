...
model integration**, along with **updated service images** and **documentation
improvements**.

## What's New

- **UDF Development Guide** — Added a comprehensive guide for writing User
  Defined Functions (UDFs) covering architecture, implementation steps, and
  examples.
