...
[Wind Turbine Anomaly Detection](./wind-turbine-anomaly/how-it-works.md) demonstrates a time series use case by detecting anomalous power generation patterns
in wind turbines, relative to wind speed.

[Weld Anomaly Detection](./weld-anomaly-detection/how-it-works.md) demonstrates how AI-driven analytics enable edge devices to monitor weld quality.
