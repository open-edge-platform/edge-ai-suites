...
The [DL Streamer Pipeline Server](https://docs.openedgeplatform.intel.com/2026.2/edge-ai-libraries/dlstreamer-pipeline-server/index.html) microservice reads the frames/images from the MediaMTX server over RTSP protocol, runs the configured DL weld
