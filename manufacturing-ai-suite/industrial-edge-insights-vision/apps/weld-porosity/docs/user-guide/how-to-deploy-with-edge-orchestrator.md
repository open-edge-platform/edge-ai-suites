...
1. On the Setup a Deployment page, select the **wp** package for the deployment from the list, and click **Next**. The Select a Profile step appears.
...
The **Weld Porosity** Sample Application is fully deployed when the applications become green and the status is shown as _Running_.
...
### Access the **Weld Porosity** Sample Application
...
1. Follow the steps described in the **Weld Porosity** [Documentation](<how-to-deploy-with-helm.md#run-multiple-ai-pipelines>) on usage of the application.
