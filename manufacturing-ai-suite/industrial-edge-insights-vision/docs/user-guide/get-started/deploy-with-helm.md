...
For GPU- and NPU-based pipelines, ensure you have done the necessary [setup](../how-to-evaluate-accelerate/use-gpu-for-inference.md#deploying-with-helm) from here, and start the respective pipelines.
