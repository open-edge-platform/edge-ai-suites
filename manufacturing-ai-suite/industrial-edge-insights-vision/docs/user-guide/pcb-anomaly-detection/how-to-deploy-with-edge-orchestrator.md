...
1. Follow the steps in the **PCB Anomaly Detection** [Documentation](how-to-deploy-using-helm-charts.md#deploy-the-application) on the usage of the application.
