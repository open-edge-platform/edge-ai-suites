...
```dockerfile
FROM intel/dlstreamer-pipeline-server:2026.1.0-ubuntu24-rc1
...
# For Ubuntu24 intel/dlstreamer-pipeline-server:2026.1.0-ubuntu24-rc1 base image
...
```bash
docker build -t intel/dlstreamer-pipeline-server:2026.1.0-ubuntu24-rc1-gencamsrc-balluff -f BalluffDockerfile .
```
...
> update .env DLSTREAMER_PIPELINE_SERVER_IMAGE=intel/dlstreamer-pipeline-server:2026.1.0-ubuntu24-rc1-gencamsrc-balluff
...
```bash
DLSTREAMER_PIPELINE_SERVER_IMAGE=intel/dlstreamer-pipeline-server:2026.1.0-ubuntu24-rc1-gencamsrc-balluff
```
