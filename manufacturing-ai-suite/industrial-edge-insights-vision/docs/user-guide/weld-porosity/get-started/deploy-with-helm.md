...
6. Download and prepare the model.
   ...
   ```sh
   export MODEL_URL='https://github.com/open-edge-platform/edge-ai-resources/raw/c69ebe4e8baa30f6bcfbace88babdd276adcc459/models/INT8/weld_porosity_classification.zip'
