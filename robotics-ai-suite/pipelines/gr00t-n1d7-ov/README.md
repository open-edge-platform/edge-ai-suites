...
This project extends the open-source project [isaac-gr00t](https://github.com/NVIDIA/Isaac-GR00T) to provide OpenVINO acceleration features on Intel compute platforms. To set up the environment, you need to initialize and patch the submodule:
