...
Comprehensive documentation on this component is available here: [Imitation Learning - ACT](https://docs.openedgeplatform.intel.com/2026.1/edge-ai-suites/robotics-ai-suite/embodied/sample_pipelines/imitation_learning_act.html)
...
> [!IMPORTANT]
> Intel® Extension for PyTorch workloads are incompatible with the NPU driver. For more details, please refer to the [Troubleshooting page](https://docs.openedgeplatform.intel.com/2026.1/edge-ai-suites/robotics-ai-suite/troubleshooting.html).
