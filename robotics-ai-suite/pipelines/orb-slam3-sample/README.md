...
Comprehensive documentation on this component is available here: [Link](https://docs.openedgeplatform.intel.com/2026.2/edge-ai-suites/robotics-ai-suite/software_references/humanoid/sample_pipelines/ORB_VSLAM.html)
...
> [!IMPORTANT]
> Please make sure you have all the prerequisites and installation in [Get Started](https://docs.openedgeplatform.intel.com/2026.2/edge-ai-suites/robotics-ai-suite/platform_foundation/getting_started.html) before proceeding.
> And follow the guide [Install Realsense SDK](https://docs.openedgeplatform.intel.com/2026.2/edge-ai-suites/robotics-ai-suite/platform_foundation/getting_started/step_by_step.html#5-install-realsense-camera-sdk) to install Realsense SDK.
...
1. Make sure Realsense SDK installed.
   ...
   If not, follow
   [Install Realsense SDK](https://docs.openedgeplatform.intel.com/2026.2/edge-ai-suites/robotics-ai-suite/platform_foundation/getting_started/step_by_step.html#5-install-realsense-camera-sdk)
