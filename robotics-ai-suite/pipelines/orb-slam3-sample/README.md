...
Comprehensive documentation on this component is available here: [Link](https://docs.openedgeplatform.intel.com/2025.2/edge-ai-suites/robotics-ai-suite/embodied/sample_pipelines/ORB_VSLAM.html)
...
> [!IMPORTANT]
> Please make sure you have all the prerequisites and installation in [Installation & Setup](https://docs.openedgeplatform.intel.com/2025.2/edge-ai-suites/robotics-ai-suite/embodied/installation_setup.html) before proceeding.
> And follow the guide [Install Realsense SDK](https://docs.openedgeplatform.intel.com/2025.2/edge-ai-suites/robotics-ai-suite/embodied/installation_setup/installation/realsense.html) to install Realsense SDK.

## Installation

1. Make sure Realsense SDK installed. If not, follow [Install Realsense SDK](
https://docs.openedgeplatform.intel.com/2025.2/edge-ai-suites/robotics-ai-suite/embodied/installation_setup/installation/realsense.html) to install Realsense packages.
...
```
$ git clone https://github.com/open-edge-platform/edge-ai-suites.git -b release-2025.2.0 --recurse-submodules
```
