...
as described in the [Robot Keyboard Teleop](../../../software_references/amr/deployment/teleop_deploy.md) tutorial.
...
Prepare the robot according to the relevant platform integration guide.
...
![pointcloud_groundfloor_segmentation_demo_parameters](../../../hardware_blueprints/amr/images/pointcloud_groundfloor_segmentation_demo_parameters.png)
