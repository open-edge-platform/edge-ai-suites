...
2. `main.cpp` should be in the directory. [View it on GitHub](https://github.com/open-edge-platform/edge-ai-suites/blob/release-2026.2.0/robotics-ai-suite/docs/user-guide/software_references/amr/sources/sample/main.cpp) to read the comments for the code.
