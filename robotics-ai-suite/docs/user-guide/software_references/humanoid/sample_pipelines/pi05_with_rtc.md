...
This project extends the open-source project [LeRobot](https://github.com/huggingface/lerobot) to provide OpenVINO™ acceleration and Real-Time Chunking (RTC) features on Intel compute platforms. Get [the source code](https://github.com/open-edge-platform/edge-ai-suites/tree/release-2026.2.0/robotics-ai-suite/pipelines/pi05-rtc-ov) from the Open Edge Platform repo. To set up the environment, you need to initialize and patch the submodule:
