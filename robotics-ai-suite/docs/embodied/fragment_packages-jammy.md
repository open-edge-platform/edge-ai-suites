...
|---|---|---|
| [Linux Board Support Package (BSP)](./packages/linuxbsp.md) | linux-intel-rt-experimental<br>linux-intel-experimental | Linux LTS real-time kernel (preempt-rt) optimized for Intel® platforms, version 6.12 and generic kernel, version 6.12.8 |
