...
For details, see [Model Zoo](https://docs.openvino.ai/latest/model_zoo.html).

## ADBSCAN

[**Tutorial**](../../dev_guide/tutorials_amr/navigation/adbscan/index.rst)
...
[**Tutorial**](../../dev_guide/tutorials_amr/perception/one-api/index.rst)
...
Depth Image to Laser Scan, converts a depth image to a laser scan
for use with navigation and localization - but in another OS.
...
[**Tutorial**](../../dev_guide/tutorials_amr/navigation/collaborative-slam.rst)
...
Framework for [Service Robots paper](https://arxiv.org/abs/2102.03228).
...
Cartographer is a system that provides real-time simultaneous
localization and mapping (SLAM) based on real-time 2D LiDAR sensor data. It
is used to generate as-built floor plans in the form of occupancy grids - but in another OS.
