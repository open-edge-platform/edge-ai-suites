...
[Prepare the Target System](https://github.com/open-edge-platform/edge-ai-suites/blob/release-2026.0.0/robotics-ai-suite/robot-vision-control/docs/source/getstarted/prepare_system.md).
