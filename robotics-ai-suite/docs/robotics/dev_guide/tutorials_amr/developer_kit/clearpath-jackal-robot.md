...
- [Jackal Unmanned Ground Vehicle](https://clearpathrobotics.com/jackal-small-unmanned-ground-vehicle/) product page
...
- [Install the Autonomous Mobile Robot on Jackal Robot's Onboard Computer](clearpath-jackal/jackal-intel-robotics-sdk.md) - This page depicts
  how to install and configure the Autonomous Mobile Robot on the Jackal robot.

- [Control the Jackal Motors Using a Keyboard](clearpath-jackal/jackal-keyboard-teleop.md) - This page describes
  how to run a simple test with manual control of the Jackal motors.

- [Execute the Wandering Application on the Jackal Robot](clearpath-jackal/jackal-wandering.md) - This page demonstrates
