...
echo " Next Steps:"
echo ""
echo "1⃣  Start ROS2 monitoring:"
echo "   ./monitor_stack.py --session grafana_demo"
echo ""
echo "2⃣  Start metrics exporter (in another terminal):"
echo "   ./src/prometheus_exporter.py --session-dir monitoring_sessions/grafana_demo"
echo ""
echo "3⃣  Open Grafana dashboard:"
