...
Comprehensive documentation on this component is available here: [dev guide](https://docs.openedgeplatform.intel.com/2026.2/edge-ai-suites/robotics-ai-suite/components/benchmarking/robotics-system-profiler/index.html).
...
| Requirement | Install |
|-------------|---------|
| ROS2 Humble / Jazzy | [Intel Robotics AI Suite Getting Started](https://docs.openedgeplatform.intel.com/2026.2/edge-ai-suites/robotics-ai-suite/platform_foundation/getting_started.html) |
