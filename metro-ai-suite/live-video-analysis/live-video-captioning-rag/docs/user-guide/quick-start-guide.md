...
> 2. If you do not have a camera stream, configure a simulated RTSP stream by following [these instructions](../../../live-video-captioning/docs/user-guide/get-started/simulated-rtsp-stream-guide.md).
