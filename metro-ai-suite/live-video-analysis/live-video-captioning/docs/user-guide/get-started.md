...
- OpenVINO-compatible VLM in `ov_models/`. For conveniance, use the [download models script](https://github.com/open-edge-platform/edge-ai-suites/blob/main/metro-ai-suite/live-video-analysis/live-video-captioning/download_models.sh) provided to prepare the model.
