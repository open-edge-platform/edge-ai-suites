...
- OpenVINO-compatible VLM in `ov_models/`. User may follow the steps outlined in [Model Preparation](./model-preparation.md) provided to prepare the model.
...
8. **Stop the Live Video Captioning Application**:
