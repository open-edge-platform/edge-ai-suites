...
The Metro AI Suite includes Intel software such as OpenVINO™; toolkit, Deep Learning Streamer, Intel®; oneAPI, and other tools, libraries, and microservices for media analytics and AI performance optimization for abovementioned use cases.  
