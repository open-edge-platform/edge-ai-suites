...
Comment out CPU and GPU volume mount and uncomment the NPU volume mount present in [compose.yml](https://github.com/open-edge-platform/edge-ai-suites/blob/release-2026.1.0/metro-ai-suite/image-based-video-search/compose.yml)
...
In [values.yaml](https://github.com/open-edge-platform/edge-ai-suites/blob/release-2026.1.0/metro-ai-suite/image-based-video-search/chart/values.yaml) file, change value of `pipeline` config present under
