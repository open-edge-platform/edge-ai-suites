...
To deploy the **Smart Parking** Sample Application with the Edge Orchestrator, follow the steps described in this document.
...
1. On the Setup a Deployment page, select the **sp** package for the deployment from the list, and click **Next**. The Select a Profile step appears.
...
### Running the AI Pipeline for **Smart Parking** sample application

Follow the steps described in the **Smart Parking** [Documentation](<how-to-deploy-with-helm.md#deploy-the-application-and-run-multiple-ai-pipelines>) on usage of the application.
