...
Based on the analysis of `server_docs/docker-compose.yml`, please download the following files from your server and place them in the corresponding structure. 
