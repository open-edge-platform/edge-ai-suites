...
*   **System Requirements**: Verify that the system meets the [minimum requirements](docs/user-guide/system-requirements.md).
*   **Docker Installation Complete**: Install Docker, For installation instructions, see [Get Docker](https://docs.docker.com/get-docker/).
*   **MQTT Explorer**: Ensure access to [MQTT explorer](https://mqttexplorer.com/download/) for traffic data streaming and verifying payloads.
