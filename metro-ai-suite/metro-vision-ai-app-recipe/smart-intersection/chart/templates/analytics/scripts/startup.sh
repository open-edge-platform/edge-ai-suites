{{/*
Template for Analytics service startup script
*/}}
{{- define "analytics.startup-script" -}}
...
/home/scenescape/Scenescape/analytics-cmd --resturl https://web.scenescape.intel.com/api/v1 --restauth=/tmp/secrets/controller.auth --broker broker.scenescape.intel.com --brokerauth /tmp/secrets/controller.auth --rootcert /tmp/secrets/scenescape-ca.pem
{{- end -}}
