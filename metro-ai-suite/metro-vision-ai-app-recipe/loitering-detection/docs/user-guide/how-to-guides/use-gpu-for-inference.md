...
Read the DL Streamer [docs](https://docs.openedgeplatform.intel.com/dev/edge-ai-libraries/dlstreamer/dev_guide/gpu_device_selection.html) for more details.
...
If you have multiple GPUs (integrated/discrete), please follow the [GPU Device Selection](https://dlstreamer.github.io/dev_guide/gpu_device_selection.html)
