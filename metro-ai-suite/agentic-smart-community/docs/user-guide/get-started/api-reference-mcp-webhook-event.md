...
Implementation entry point: [packages/mcp-server/src/events-endpoint.ts](https://github.com/open-edge-platform/edge-ai-suites/blob/main/metro-ai-suite/agentic-smart-community/packages/mcp-server/src/events-endpoint.ts).
...
This matrix is enforced end-to-end by [packages/mcp-server/src/events-endpoint.ts](https://github.com/open-edge-platform/edge-ai-suites/blob/main/metro-ai-suite/agentic-smart-community/packages/mcp-server/src/events-endpoint.ts) and pinned by [tests/test_api/test_webhook_api.py](https://github.com/open-edge-platform/edge-ai-suites/blob/main/metro-ai-suite/agentic-smart-community/tests/test_api/test_webhook_api.py).
