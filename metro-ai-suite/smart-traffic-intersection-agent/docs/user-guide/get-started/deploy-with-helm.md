...
```bash
helm pull oci://registry-1.docker.io/intel/smart-traffic-intersection-agent --version 2026.2.0-helm
```
...
```bash
tar -xvf smart-traffic-intersection-agent-2026.2.0-helm.tgz
```
