...
- Runs the VLM model defined in the Frigate [config file](https://github.com/open-edge-platform/edge-ai-suites/blob/release-2026.2.0/metro-ai-suite/smart-nvr/resources/frigate-config/config.yml)
...
```bash
helm pull oci://registry-1.docker.io/intel/smart-nvr --version 2026.2.0
```
...
```bash
tar -xvf smart-nvr-2026.2.0.tgz
```
