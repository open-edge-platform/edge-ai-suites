...
Build docker image and Run in docker container, for information see the [guide](https://github.com/open-edge-platform/edge-ai-suites/blob/release-2026.0.0/metro-ai-suite/video-processing-for-nvr/docker/README.md).
