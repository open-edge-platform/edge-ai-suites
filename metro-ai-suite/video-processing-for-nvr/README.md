...
- Several reference applications are in the example folder, built with APIs from VPP SDK to construct video analytic and transcoding workflows.
...
The sample application is licensed under [APACHE 2.0](https://github.com/open-edge-platform/edge-ai-suites/blob/release-2026.0.0/LICENSE).
