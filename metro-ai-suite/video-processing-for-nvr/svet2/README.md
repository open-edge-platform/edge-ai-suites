...
The sample application depends on the Video Processing Platform SDK and [live555](http://www.live555.com/)
...
- Intel® platforms supported by the OneVPL GPU

## How to build

1. Run `live555_install.sh` to install live555
2. Install the Video Processing Platform SDK and dependencies
